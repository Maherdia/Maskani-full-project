...
const registerSchema = z.object({
  ...
  role: z.enum(['Owner', 'admin', 'Student','User'], {
...
const Login = () => {
  ...
  const onLoginSubmit = async (values: LoginFormValues) => {
    try {
      ...
      const response = await authAPI.login({
        ...
        Role: 'Student' // Default to Student role for login
      });
  ...
  const onRegisterSubmit = async (values: RegisterFormValues) => {
    try {
      ...
      if (axiosError.message.includes("undefined")) {
        errorMessage = "A role must be selected for registration.";
