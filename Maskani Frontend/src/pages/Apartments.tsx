  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Student Housing</h1>
          <p className="text-gray-600">
            Find suitable accommodation near your university
          </p>
        </div>
        ...
        {isMobile && (
          <Button
            ...
            variant="outline"
            className="mb-4 w-full flex items-center justify-center gap-2 bg-white border-2 border-gray-200 text-gray-700 hover:bg-gray-50"
          >
          ...
          <div className={`lg:col-span-2 ${showMap && isMobile ? 'hidden' : 'block'}`}>
            {loading ? (
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 text-center">
                <p className="text-gray-600 mb-4">No accommodations found matching your search criteria.</p>
                <Button 
                  onClick={() => handleSearch({})} 
                  variant="outline"
                  className="text-gray-600 border-2 border-gray-200 hover:bg-gray-50"
                >
