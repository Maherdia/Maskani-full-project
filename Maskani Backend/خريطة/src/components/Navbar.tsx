...
import { Search, Menu, User as UserIcon, BedDouble } from "lucide-react";
  ...
  return (
    <nav className="w-full bg-white py-4 px-6 shadow-sm flex items-center justify-between">
      ...
      <div className="hidden md:flex space-x-8">
        ...
        <Link to="/rooms" className="text-gray-700 hover:text-gray-900 font-medium flex items-center">
        ...
        {isAuthenticated && user?.role === 'Student' && (
          <Link to="/my-bookings" className="text-gray-700 hover:text-gray-900 font-medium">
            حجوزاتي
          </Link>
        )}
        {!isAuthenticated ? (
        ...
        {isAuthenticated && (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              {user?.role === 'Student' && (
                <DropdownMenuItem className="cursor-pointer" asChild>
                  <Link to="/booking-details">حجوزاتي</Link>
                </DropdownMenuItem>
              )}
        ...
        <Sheet>
          ...
          <SheetContent side="right" className="w-[300px] sm:w-[400px]">
            <div className="flex flex-col space-y-4 mt-8">
              ...
              <Link to="/rooms" className="text-gray-700 hover:text-gray-900 font-medium text-lg flex items-center">
                <BedDouble className="h-4 w-4 ml-1" />
                Student Booking
              </Link>
              {isAuthenticated && user?.role === 'Owner' && (
              ...
              {isAuthenticated && user?.role === 'Student' && (
                <Link to="/my-bookings" className="text-gray-700 hover:text-gray-900 font-medium text-lg">
                  حجوزاتي
                </Link>
              )}
              {!isAuthenticated ? (
